    ...
    <div className="Categories">
        <div className="col">
            <div className="row">
                ...
                <button>
                    <Link className="link" to="/products/women">Sale</Link>
                </button>
            </div>
            <div className="row">
        ...
        <div className="col">
            <div className="row">
                ...
                <button>
                    <Link className="link" to="/products/women">New Season</Link>
                </button>
            </div>
        </div>
        <div className="col col-l">
            <div className="row">
                ...
                <button>
                    <Link className="link" to="/products/women">Men</Link>
                </button>
                    </div>
                </div>
                <div className="col">
                ...
                <button>
                    <Link className="link" to="/products/women">Accessories</Link>
                </button>
                    </div>
                </div>
            </div>
