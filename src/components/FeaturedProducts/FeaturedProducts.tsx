...
const FeaturedProducts = (props: {type: string}) => {
  ...
  return (
    <div className="featuredProducts">
        <div className="top">
            ...
            <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Corporis ratione accusamus quibusdam ab beatae saepe, quo illum possimus et earum, eos aut magnam debitis consequatur incidunt, molestias quidem inventore fugit!</p>
        </div>
